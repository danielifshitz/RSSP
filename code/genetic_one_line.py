...
class GA_one_line:
    ...
    def solve(self, job, w=None, x=None, y=None, z=None):
        """
        ...
        fitness = [job.find_ub_ga(genotype["operations"], genotype["modes"], True)["value"] for genotype in population]
        ...
        for generation in range(self.generations):
            ...
            fitness += [job.find_ub_ga(genotype["operations"], genotype["modes"], True)["value"] for genotype in population[self.population_size:]]
            new_population = []
            new_fitness = []
        ...
        solution_draw_data = job.find_ub_ga(population[0]["operations"], population[0]["modes"], True)["to_draw"]
        ...
        return {"value": fitness[0], "generations": generation, "time": run_time, "to_draw": solution_draw_data, "feasibles": 100, "cross_solutions": 0}
